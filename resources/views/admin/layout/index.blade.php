...
@section('content')
    <div class="col-lg-3 col-6 mx-3">
        ...
        <div class="small-box text-bg-warning">
            ...
            <a @if (Gate::allows('isAdmin')) href="{{ route('view-All-User.now') }}" @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg end">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="admin/dist/assets/img/user3-128x128.jpg"
                                                alt="message user image" />
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="admin/dist/assets/img/user1-128x128.jpg"
                                                alt="message user image" />
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ 'admin/dist/assets/img/user7-128x128.jpg' }}"
                                                        alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Sarah Doe
